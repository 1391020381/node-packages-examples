...
var Loader = /** @class */ (function () {
    ...
    Loader.prototype.loadConfig = function () {
        var configDef = __dirname + '/config/config.default.js';
        var configEnv = __dirname + (process.env.NODE_ENV === 'production' ? '/config/config.pro.js' : '/config/config.dev.js');
        var conf = require(configEnv);
        var confDef = require(configDef);
        var merge = Object.assign({}, conf, confDef);
            ...
            get: function () {
                ...
                if (!loaded['service']) {
                    ...
                    service.forEach(function (d) {
                        ...
                        loaded['service'][name] = new mod(_this, _this.app);
                    });
        ...
        Object.keys(routers).forEach(function (key) {
            ...
            _this.router[method](path, function (ctx) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    instance = new _class(ctx, this.app);
                    instance[handler]();
                    return [2 /*return*/];
                });
            }); });
